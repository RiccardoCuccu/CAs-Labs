...
print_char proc near                ; PRINT CHARACTERS
        ...
        mov AH, 2                   ; writing
printl2:mov DL, [DI]                ; load character
	    int 21H                     ; interrupt
	    inc DI                      ; increment index
	    dec CX                      ; decrement CX
...
count0: cmp [DI], 65                ; check if the ASCII code is greater than 65
...
count99:inc DI                      ; increment index
...
start:  cmp [DI], 65                ; check if the ASCII code is greater than 65
