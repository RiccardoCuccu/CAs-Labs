...
MATRIX:
		CALL	MUL_ROW			; calculate the value of the single row
...
ROW:		
		CALL	MUL_ELE			; calculate the value of the single element
...
MAX:
		CMP	AX, 25600		; check if the number to print is greater than 25600 (25600/100=2560=>OVERFLOW)
		JB	BIG
		MOV	BX, 1000		; divisor
		XOR	DX, DX			; erase DX
...
BIG:
		CMP	AX, 2560		; check if the number to print is greater than 2560 (2560/10=256=>OVERFLOW)
		JB	POS
		MOV	BL, 100			; divisor
...
ROWPW:
		MOV	AX, [BX][SI]		; move the number to print
...
ROWPB:
		MOV	AL, [BX][SI]		; move the number to print
		CBW
		CALL	PRINTN			; print number
